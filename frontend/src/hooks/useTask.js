...
// Notes display newest-first (per review feedback, overriding design.md's
// original oldest-first mockup) — which is exactly the order the API
// already returns them in (paginating by "load the next older batch"), so
// no reversing is needed: "load more" appends the next (older) page to the
// end, and a freshly-posted note goes at the front.
