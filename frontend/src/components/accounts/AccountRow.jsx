export default function AccountRow({ account, onClick }) {
  return (
    <tr className="cursor-pointer border-b border-border bg-bg-surface hover:bg-bg-raised" onClick={() => onClick(account)}>
      <td className="px-3 py-2 text-[13px] font-medium text-accent">{account.name}</td>
